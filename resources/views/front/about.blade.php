...
<section class="mt-40">
  <div class="px-50 container" uk-scrollspy="cls:uk-animation-fade">
    ...
    <p>
      Somos una empresa apasionada por el diseño y la creación de mobiliario único y funcional. Nuestra misión es
      transformar espacios y mejorar la calidad de vida de las personas a través de PROYECTOS exclusivos y atractivos
      que
      se integran armoniosamente en su entorno.
    </p>
    <h2>Nuestra Historia</h2>
    <p>
      Fundada en el año 2017 en la ciudad de Barranquilla, V y G Diseño Mobiliario ha evolucionado desde sus humildes
      comienzos como un
      pequeño taller y se ha ido convirtiendo en una reconocida empresa de diseño de mobiliario para espacios en el
      hogar y la oficina.
      Durante nuestra trayectoria, hemos mantenido un compromiso inquebrantable con la excelencia, la responsabilidad,
      la innovación y la entera satisfacción de
      nuestros clientes.
    </p>
    ...
    <div class="uk-column-1-2@s">
      ...
      <div>
        <br>
        <h3>la elección perfecta para tu mobiliario</h3>
        <p class="text-justify">
          En V&G Diseño Mobiliario, entendemos que la elección de mobiliario para tu hogar es una decisión importante
          que
          refleja tu estilo, comodidad y personalidad. Aquí te presentamos las razones por las que deberías elegirnos
          como
        ...
        <p>En V&G Diseño Mobiliario, nos enorgullece ser tu elección para mobiliario para el hogar y oficina. Nuestra
          pasión por el
          diseño, la calidad y la satisfacción del cliente se refleja en cada proyecto que creamos. Estamos ansiosos por
          colaborar contigo y transformar tu hogar en un espacio funcional y hermoso que realmente refleje tu estilo
          personal.</p>
      </div>
    </div>
